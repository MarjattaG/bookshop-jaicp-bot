...
theme: /
    ...
    state: Welcome
        ...
        state: Choice
            q!: *(выбрать*/выбер*/найти*/найд*/подобер*/подобр*/хоч*)(книг*/книж*/*читать)*
        ...
        state: New
            q!: *(нов*)*
            a: Рад, что тебе интересно! Выбери жанр, который тебя интересует. Я покажу, какие новинки ожидаются в этом жанре в 2023 году.
            buttons:
    ...
    state: CatchAll
        ...
        random:
            ...
            a: Прости, боюсь, я тебя не понял. Можешь написать по-другому?

    state: Leave
        q!: *(пок*/до свидания/до */бывай)*
        a: Прежде чем ты ушел, скажи, пожалуйста, удалось ли тебе найти всё, что искал?
        state: Yes
            q!: *(ага/угу/да/конечно/вполне/разумеется/наш*)*
            ...
            buttons:
                ...
                "Воздержусь" -> /Bye
        state: No
            q!: *(не*/не(*нрав*/подошл*/подход*/наш*)/откаж*/фигня/отстой/фу)*
    ...
    state: Sad_bye
        a: Всего доброго! Обещаю, в следующий раз, когда ты вернешься, я стану лучше!
        EndSession:
